 ...
 * @public
 */
export type AbortSignal = typeof globalThis extends { AbortSignal: { prototype: infer T } }
  ? T
  : {
      aborted: boolean;
      readonly reason?: any;
...
export type AbortController = typeof globalThis extends { AbortController: { prototype: infer T } }
  ? T
  : {
