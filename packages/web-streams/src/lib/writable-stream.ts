...
import { newPromise, promiseRejectedWith, promiseResolvedWith, setPromiseIsHandledToTrue, uponPromise } from './helpers/webidl';
import { DequeueValue, EnqueueValueWithSize, PeekQueueValue, type QueuePair, ResetQueue } from './abstract-ops/queue-with-sizes';
...
class WritableStream<W = any> {
  ...
  constructor(rawUnderlyingSink: UnderlyingSink<W> | null | undefined = {}, rawStrategy: QueuingStrategy<W> | null | undefined = {}) {
