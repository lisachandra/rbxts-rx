...
import type { ReadableStreamBYOBReaderReadOptions, ValidatedReadableStreamBYOBReaderReadOptions } from './reader-options';
...
export function ReadableStreamFulfillReadIntoRequest(stream: ReadableByteStream, chunk: ArrayBufferView, done: boolean) {
...
export function ReadableStreamBYOBReaderRead<T extends NonShared<ArrayBufferView>>(
  ...
  if (stream._state === 'errored') {
    ...
    ReadableByteStreamControllerPullInto(stream._readableStreamController as ReadableByteStreamController, view, min, readIntoRequest);
  }
}
