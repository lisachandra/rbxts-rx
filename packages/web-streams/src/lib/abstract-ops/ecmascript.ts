import { PerformPromiseThen, promiseRejectedWith, promiseResolve, promiseResolvedWith, reflectCall } from 'lib/helpers/webidl';
...
export function CopyDataBlockBytes(dest: ArrayBuffer, destOffset: number, src: ArrayBuffer, srcOffset: number, n: number) {
...
export const SymbolAsyncIterator: (typeof Symbol)['asyncIterator'] =
  Symbol.asyncIterator ?? Symbol.for?.('Symbol.asyncIterator') ?? '@@asyncIterator';
...
function GetIterator<T>(obj: SyncOrAsyncIterable<T>, hint: 'async', method?: SyncOrAsyncIteratorMethod<T>): AsyncIteratorRecord<T>;
function GetIterator<T>(obj: Iterable<T>, hint: 'sync', method?: SyncOrAsyncIteratorMethod<T>): SyncIteratorRecord<T>;
function GetIterator<T>(obj: SyncOrAsyncIterable<T>, hint = 'sync', method?: SyncOrAsyncIteratorMethod<T>): SyncOrAsyncIteratorRecord<T> {
