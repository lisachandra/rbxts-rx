interface Instance {
  ...
  FindFirstChild<T extends Instance = Instance>(childName: number | string, recursive?: boolean): N<T>;
  ...
  WaitForChild<K extends ExtractKeys<this, Instance> = ExtractKeys<this, Instance>>(childName: K, timeout: number): N<this[K]>;
